...
export const siteProfile: SiteProfile = {
  name: "Vasu Kasipuri",
  role: "NetSuite Architect · Agentic AI",
  identity:
  ...
  siteUrl: SITE_URL,
  description:
    "NetSuite Architect building production-grade agentic AI for enterprise finance, with 12+ years designing reliable, observable, audit-ready ERP and revenue automation at scale.",
...
That work now converges somewhere specific: AI-driven financial automation. Not chatbots bolted onto an ERP, but agentic systems with guardrails, observability, and reconciliation designed in from day one, so the people who actually run the business can ask their systems real questions and trust the answers.`,
